...
const devData = {
  ...
  stats: {
    abilities: [
      { name: 'Fixer', level: 95, icon: 'BrainCircuit', color: 'hsl(var(--chart-1))' },
        ...
        <div className="relative z-10 flex flex-col p-6 md:p-8">
          <div className="flex flex-col md:flex-row items-center gap-6 md:gap-8">
            ...
            <Tabs defaultValue="player-info" className="w-full">
              ...
              <TabsContent value="player-stats" className="mt-4 bg-black/20 p-4 rounded-md border border-primary/20">
